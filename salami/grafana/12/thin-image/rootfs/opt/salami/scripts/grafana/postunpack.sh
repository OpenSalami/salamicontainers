...
grafana_plugin_list="grafana-clock-panel briangann-gauge-panel jdbranham-diagram-panel vonage-status-panel larona-epict-panel pierosavi-imageit-panel grafana-polystat-panel scadavis-synoptic-panel"
